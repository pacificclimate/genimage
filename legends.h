#ifndef __GENIMAGE_LEGENDS_H
#define __GENIMAGE_LEGENDS_H
enum ColourMaps { CONTINUOUS, STEPWISE };
enum Direction { NORMAL, REVERSED };

const static int continuous[2][50] = {
...
const static int stepwise[2][12] = {
